    ...
    if ($('#sidpath').val() == "null") {
        ...
        for (var i = 0; i < rowNumber; i++) {
            ...
            for (var j = 0; j < colNumber; j++) {
                html += "<td ><input type='file' accept='image/*' name='pic" + (i * rowNumber + j + 1) + "' /></td>";
            }
            html += "</tr>";
        }
        ...
        for (var i = 0; i < rowNumber; i++) {
            html += "<tr>";
            for (var j = 0; j < colNumber; j++) {
                html += "<td background='./LXXAdd.png'><input type='file' accept='image/*' name='pic" + (i * rowNumber + j + 1) + "' /></td>";
            }
            html += "</tr>";
        }
